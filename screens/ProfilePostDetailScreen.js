...
const ProfilePostDetailScreen = (props) => {
  const postId = props.navigation.getParam("postId");

  const selectedPostDetail = useSelector((state) =>
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.captionContainer}>
          <View style={styles.caption}>
            <Text>{selectedPostDetail.caption}</Text>
          </View>
      ...
      <View style={styles.mapContainer}>
        ...
        <View style={styles.mapPreviewContainer}>
          <MapPreview
            ...
            location={{ lat: selectedPostDetail.lat, lng: selectedPostDetail.lng }}
          />
        </View>
      </View>
    </ScrollView>
